...
public class QueryTest {
    ...
    private void updateTravelReview() {
        ...
        Query query = session.createQuery("update TravelReview set review=:review where id=22");
    ...
    private void deleteTravelReview() {
        ...
        Query query = session.createQuery("delete TravelReview where id=21");
        int success = query.executeUpdate();
    ...
    public static void main(String[] args) {
        ...
        // test.getTravelReviewWithQueryParam(JOptionPane.showInputDialog(null,"Please enter a city:","Peter kocha siusiaki",JOptionPane.WARNING_MESSAGE));
